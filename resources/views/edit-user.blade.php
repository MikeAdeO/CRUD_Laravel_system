                    ...
                    <div class="card-body">
                        <form method="post" action="{{ url('/user/update/'.$user->id ) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $user->first_name }}" name="first_name" aria-describedby="first_name">
                               
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">Last Name</label>
                                <input type="text" value="{{ $user->last_name }}" class="form-control" name="last_name" aria-describedby="last_name">
                                
                            </div>

                            <div class="form-group">
                                <label for="email_patient">Email address</label>
                                <input type="email" value="{{ $user->email_patient }}" class="form-control" name="email_patient" >
